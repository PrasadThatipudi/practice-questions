...
const isWordLongerThan = function (threshold) {
  return function (word) {
    return isGreaterThan(threshold)(stringLength(word));
  };
};
...
const isEqual = function (threshold) {
...
// books with more than 200 pages [{title: "Book 1", pages: 150}, {title: "Book 
// 2", pages: 250}] => [{title: "Book 2", pages: 250}]
